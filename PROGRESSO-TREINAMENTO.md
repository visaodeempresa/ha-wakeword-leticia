...
| 3 | Download de dados auxiliares | 🔄 Em execução | 23:36-... | HF_TOKEN configurado, MIT RIRs OK |
...
|-----------|---------|--------|--------|
| 3a | MIT RIRs (271 WAV) | `load_dataset` | ✅ Resolvido 270/270, baixando... |
| 3b | AudioSet (tar) | `wget` | ⏳ |
| 3c | FMA (1 hora) | `load_dataset` | ⏳ |
| 3d | ACAV100M (17.3 GB) | `wget` | ⏳ |
| 3e | Validation (185 MB) | `wget` | ⏳ |
